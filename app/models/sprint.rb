...
class Sprint < ActiveRecord::Base
  ...
  validates_presence_of :sprint_start_date, :unless => (:is_product_backlog? or :is_kanban?)
  validates_presence_of :sprint_end_date, :unless => (:is_product_backlog? or :is_kanban?)
